...
CREATE OR REPLACE PROCEDURE UPDATE_DISC
    ...
    CURSOR D2 IS
    SELECT DISC.ID FROM DISCIPLINES DISC
    WHERE DISC.NAME LIKE DISC_NAME_NEW;
...
BEGIN
    ...
    OPEN D2;
    FETCH D2 INTO DISC_NEW_ID;

    UPDATE DISCIPLINES_PROFESSORS DP
    SET DP.DISCIPLINE_ID = DISC_NEW_ID
    WHERE DP.DISCIPLINE_ID = DISC_ID AND DP.PROFESSOR_ID = PROF_ID;

END;
/

EXECUTE UPDATE_DISC('Timur', 'Fathutdinov', 'КТБД', 'ИССАПР');
